  ...
  return (
    <div className="flex justify-center text-white">
      <motion.div
        ...
        initial="hidden"
        animate="visible"
        className="pb-[20px] px-[20px] flex flex-col justify-center items-center gap-5 text-center backdrop-blur-[10px] border-[1px] border-black shadow-[10px_10px_8px_#000] mt-[2rem] lg:mt-0 rounded-[20px] md:min-w-[30rem] md:max-w-[50rem] min-w-[20rem] max-w-[50rem]"
      >
        <motion.div
          variants={item}
